...
Statistical significance of the observed improvements is assessed across groups using two complementary tests: a paired Student's $t$-test and the Wilcoxon signed-rank test. Additionally, $95\%$ confidence intervals are computed for the mean $\Delta$ across groups. This approach allows us to determine whether sentiment features provide a consistent improvement across multiple sectors or industries, rather than only in isolated cases.

\subsubsection{Statistical Significance of Sentiment Contribution}
...
\subsubsection{Sector-Level Results}
...
\subsubsection{Industry-Level Results}
...
\subsubsection{Company-Level Results}
