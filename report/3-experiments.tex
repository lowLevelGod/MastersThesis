...
Here is your concise, thesis-ready LaTeX rewrite preserving exact structure, removing redundancy, keeping key statistical highlights, and adding a final discussion subsection synthesizing all results.
...
Across all aggregation levels, the results highlight clear differences between classification and regression tasks, as well as between the LSTM and PatchTST architectures. Temporal modeling consistently benefits classification, particularly at the industry and sector levels. The LSTM model provides the most stable improvements, especially for intermediate sequence lengths at the sector level and across all sequence lengths at the industry level. At the company level, shorter sequences are most effective, indicating that recent filing sentiment contains the most informative signal.
