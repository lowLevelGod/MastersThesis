...
\begin{table}
\centering
\caption{Best sentiment-driven improvements for the classification task across label types. Positive values indicate improvement for F1 Score.}
...
\begin{table}
\centering
\caption{Best overall model performance across grouping levels. Positive values indicate improvements for classification (F1 Score), while negative values indicate improvements for regression (RMSE).}
...
\begin{table}
\centering
\caption{Largest individual entity improvements across grouping levels. Positive values indicate improvements for classification (F1 Score), while negative values indicate improvements for regression (RMSE).}
...
\begin{table}
\centering
\caption{Largest individual degradations across grouping levels. Positive values indicate worse performance for regression (RMSE), while negative values indicate worse performance for classification (F1 Score).}
...
\begin{table}
\centering
\caption{Best overall model performance for each grouping and task. Positive values indicate improvements for classification (F1 Score), while negative values indicate improvements for regression (RMSE).}
...
\begin{table}
\centering
\caption{Largest individual entity improvements. Positive values indicate improvements for classification (F1 Score), while negative values indicate improvements for regression (RMSE).}
...
\begin{table}[H]
\centering
\caption{Largest individual degradations. Negative values indicate worse performance for classification (F1 Score), while positive values indicate worse performance for regression (RMSE).}
